...
val zuluStopWordsSet: Set<String> = setOf(
    "futhi",
    "kahle",
    "kakhulu",
    "kanye",
...
val portugueseStopWordsCharArraySet = CharArraySet(portugueseStopWordsSet, true)
val zuluStopWordsCharArraySet = CharArraySet(zuluStopWordsSet, true)