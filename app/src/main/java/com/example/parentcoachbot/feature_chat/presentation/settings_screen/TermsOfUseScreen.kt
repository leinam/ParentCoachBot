                                ...
                                ExpandableCard(
                                    ...
                                    content = {
                                        if (parentUser?.country == "South Africa"){
                                            ...
                                            Text(
                                                text = stringResource(id = R.string.terms_of_use_description_sa),
                                                fontSize = 15.sp,
                                                color = TextGrey,
                                            ...
                                            Text(
                                                text = stringResource(id = R.string.data_collected_header),
                                                fontSize = 18.sp,
                                            ...
                                            Text(
                                                text = stringResource(id = R.string.terms_of_use_text_Sa),
                                                fontSize = 15.sp,
                                                color = TextGrey,
                                                modifier = Modifier.padding(10.dp)
                                        ...
                                        } else
                                        {
                                            ...
                                            Text(
                                                text = stringResource(id = R.string.terms_ofuse_description_pt),
                                                fontSize = 15.sp,
                                                color = TextGrey,
                                                modifier = Modifier.padding(10.dp)
                                            ...
                                            Text(
                                                text = stringResource(id = R.string.terms_of_use_text_pt),
                                                fontSize = 15.sp,
                                                color = TextGrey,
                                                modifier = Modifier.padding(10.dp)
