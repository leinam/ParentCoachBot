...
data class ChildProfileUseCases(
    val getChildProfileById: GetChildProfileById,
    ...
    val deleteChildProfile: DeleteChildProfile,
    val deleteAllProfileData: DeleteAllProfileData,
    val updateProfileName: UpdateProfileName
)
